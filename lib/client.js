...
function FontQueryEditor({
   ...
   * reconciled with it.
   */
  const reported = _react.useRef(stored.text)
 ...
 * a component type. _react then throws "Element type is invalid" while rendering
  ...
  return _react.createElement(
    ...
    _react.createElement(
      ...
      _react.createElement(
        ...
        _react.createElement(FontChevron),
      ),
      ...
      _react.createElement(
        ...
        _react.createElement(FontChevron, { up: true }),
      ),
    ),
  )
}
